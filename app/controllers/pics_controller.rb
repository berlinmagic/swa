class PicsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pic.save
        format.html { redirect_to @owner && @owner.person ? [@owner.person, @owner.class] : @pic, notice: 'Pic was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @pic.update_attributes(params[:pic])
        format.html { redirect_to @owner && @owner.person ? [@owner.person, @owner.class] : @pic, notice: 'Pic was successfully updated.' }
